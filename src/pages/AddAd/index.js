            ...
            <PageArea>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <label className="area">
                        ...
                        <div className="area--input">
                            <select disabled={disabled} onChange={e=>setCategory(e.target.value)} require>
                                <option></option>
                    ...
                    <label className="area">
                        ...
                        <div className="area--input">
                            <input type="checkbox" disabled={disabled} checked={priceNegotiable} onChange={e=>setPriceNegotiable(!priceNegotiable)}></input>
                        </div>
                    </label>
                    <label className="area">
                        <div className="area--title">
                    ...
                    <label className="area">
                        ...
                        <div className="area--input">
                            <input type="file" disabled={disabled} ref={fileField} multiple></input>
                        </div>
                    </label>
                    <label className="area">
